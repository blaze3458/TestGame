...
public class HighscoreActivity extends AppCompatActivity {
    ...
    HighScores easyScores,mediumScores,hardScores;
    ArrayList<HighScores> highScores;
    ...
    private void getScores(){
        easyScores = new HighScores("HighScoreEasy",this);
        mediumScores = new HighScores("HighScoreMedium",this);
        hardScores = new HighScores("HighScoreHard",this);
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public static PlaceholderFragment newInstance(int sectionNumber,HighScores scoreTable) {
